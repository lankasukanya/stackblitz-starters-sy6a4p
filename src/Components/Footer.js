...
const Footer = () => {
  return (
    <div >
      ...
      <hr />
      <div className="sb_footer-below-links" style={{ display: 'flex', justifyContent: 'center' }}>
        ...
        <div className="sb_footer-links_div" style={{ display: 'flex', gap: '20px' }}>
          <a href="/" target="_blank">Terms of Service</a>
          <a href="/" target="_blank">Privacy Policy</a>
          <a href="/" target="_blank">Product</a>
          <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faFacebook} size="2x" color="purple" />
          </a>
          <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faYoutube} size="2x" color="purple" />
          </a>
          <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faInstagram} size="2x" color="purple" />
          </a>
          <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faTwitter} size="2x" color="purple" />
          </a>
